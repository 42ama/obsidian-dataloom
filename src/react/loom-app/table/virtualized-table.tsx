...
const VirtualizedTable = React.forwardRef<VirtuosoHandle, Props>(
						...
						<div className="dataloom-row">
							{columns.map((column, i) => {
								...
								if (column === null) {
									...
									const columnCells: Cell[] = rows.map(
										(row) => {
...
export default React.memo(VirtualizedTable, areEqual);
